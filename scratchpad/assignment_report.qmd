...
Anchors are a model agnostic method of explaining black box models by presenting the model's decision process for a single given instance. 
...
# Anchors from scratch {#anchors-from-scratch}

## Anchors for one dimension
