---
title: "Anchors using thompson sampling"
format: html
---
...
local_instance <- prob_matrix[prob_matrix$Positive == 0.4, "id"]
local_instance <- local_instance[2]
# doing for local_instance 33 and 38
```
...
train_df[-local_instance, ] |>
  ...
  scale_color_manual(values = c(neg_cls_col, pos_cls_col))
```
...
iwalk(sidebside, function(p, i){
  ggsave(p, filename = here::here("scratchpad/n_dim_state_plot_dump_2_2/",paste0(i,".png")),
...
gifski(
  png_files = list.files(
    here::here("scratchpad/n_dim_state_plot_dump_2_2/"),
    pattern = "*.png",
    full.names = TRUE) |> gtools::mixedsort(),
  gif_file = here::here("scratchpad/n_dim_state_plot_2_2.gif"),
  delay = 0.25,
